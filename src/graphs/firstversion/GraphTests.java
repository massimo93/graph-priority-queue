...
public class GraphTests {
	...
	private Graph<String> orientedGraph;
	private Graph<String> notOrientedGraph, notOrientedConnectedGraph, orientedConnectedGraph, emptyNotOrientedGraph;
	...
	public void setUp() {
		...
		notOrientedGraph = new Graph<String>(false);
		notOrientedConnectedGraph = new Graph<String>(false);
		orientedConnectedGraph = new Graph<String>(true);
		...
		emptyNotOrientedGraph = new Graph<String>(false);
		orientedGraph = new Graph<String>(true);
	}
	...
	public void testPrim_Success() {
		...
		LinkedList expectedVertexList = new LinkedList(
				Arrays.asList("Londra", "New York", "Dubai", "Parigi", "Roma", "Milano", "Manchester"));
